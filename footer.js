  ...
  footerEl.innerHTML = `
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
      ...
      <div>
        ...
        <ul class="space-y-4">
          <li><a href="index.html" class="text-neutral-500 hover:text-white text-sm transition-colors">Home</a></li>
          <li><a href="tournaments.html" class="text-neutral-500 hover:text-white text-sm transition-colors">Tournaments</a></li>
          <li><a href="shop.html" class="text-neutral-500 hover:text-white text-sm transition-colors">Club Shop</a></li>
          <li><a href="livescores.html" class="text-neutral-500 hover:text-white text-sm transition-colors">Live Scores</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-4">
          <li><a href="faq.html" class="text-neutral-500 hover:text-white text-sm transition-colors">How to book?</a></li>
          <li><a href="faq.html" class="text-neutral-500 hover:text-white text-sm transition-colors">Membership Levels</a></li>
          <li><a href="faq.html" class="text-neutral-500 hover:text-white text-sm transition-colors">Tournament Rules</a></li>
          <li><a href="faq.html" class="text-neutral-500 hover:text-white text-sm transition-colors">Cue Storage</a></li>
        </ul>
      </div>
